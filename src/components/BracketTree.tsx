...
export function BracketTree({ result }: Props) {
  ...
  const stages = [
    { key: 'r32',   label: '32强',    rows: data.r32 },
    { key: 'r16',   label: '16强',    rows: data.r16 },
    { key: 'qf',    label: '八强',    rows: data.qf },
    { key: 'sf',    label: '四强',    rows: data.sf },
    { key: 'final', label: '决赛',    rows: data.final },
    { key: 'champ', label: '冠军',    rows: data.champ },
  ];
