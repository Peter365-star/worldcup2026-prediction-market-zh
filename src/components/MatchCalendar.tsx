  ...
  return (
    <section className="mx-auto max-w-[1280px] px-4 py-12 sm:px-6 sm:py-20">
      ...
      <p className="mt-3 text-[10px] text-fg-3">
        En eliminatoria mostramos el matchup más probable por slot. La columna 概率 indica la probabilidad
