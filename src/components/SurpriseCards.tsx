    ...
    <section className="mx-auto max-w-[1280px] px-4 py-12 sm:px-6 sm:py-20">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <SurpriseCard
          ...
          caption={`黑马 (ELO ${underdogReachesQF.team.elo}) 晋级八强。`}
        />
        <SurpriseCard
          tone="rose"
        ...
        <SurpriseCard
          ...
          caption={`潜在黑马 (ELO ${biggestUpset.team.elo}).`}
        />
      </div>
    </section>
  );
  ...
  return (
    ...
    >
      <div className={cn('mb-4 flex items-center gap-2', c.text)}>
        {icon}
        <span className="font-mono text-[10px] uppercase tracking-[0.18em]">概率</span>
      </div>
